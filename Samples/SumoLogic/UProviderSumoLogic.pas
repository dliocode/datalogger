...
uses
  DataLogger, DataLogger.Provider.SumoLogic;
...
begin
  ...
  Logger.AddProvider(
    TProviderSumoLogic.Create
    .URL('https://endpoint4.collection.sumologic.com/receiver/v1/http/{HTTP_TOKEN}')
    );
