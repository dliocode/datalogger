unit UProviderSendChampWhatsApp;
...
uses
  System.JSON,
  DataLogger, DataLogger.Provider.SendChamp.WhatsApp;
...
begin
  ...
  Logger.AddProvider(
    TProviderSendChampWhatsApp.Create
     .AccessKey('{ACCESS_KEY}')
     .PhoneFrom('{COD_COUNTRY_NUMBER_PHONE}')
     .PhoneTo('{COD_COUNTRY_NUMBER_PHONE}')
    );
