...
uses
  System.JSON,
  DataLogger, DataLogger.Provider.Novu;
...
begin
  ...
  Logger.AddProvider(
    TProviderNovu.Create
    .ApiKey('9c8b01913aad4456cdeb6c15092d264b')
    .TemplateID('minha-notificacao')
    .SubscriberID('Subbbb')
    .EmailTo(['dldanilolucas@gmail.com', 'danilolucas@outlook.com'])
    .Subject('Meu assunto')
