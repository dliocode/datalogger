...
uses
  System.JSON,
  DataLogger, DataLogger.Provider.Grafana.Loki;
...
begin
  ...
  Logger.AddProvider(
    TProviderGrafanaLoki.Create
     .URL('https://logs-prod3.grafana.net')
     .BasicAuth('258081', 'eyJrIjoiOTRlYjYwNjdlZWMxYzZmNTE1ODFhODQ1ZGY5MGE4M2ZhZTE4NmVkOSIsIm4iOiJkYXRhbG9nZ2VyIiwiaWQiOjY4NjM3NH0=')
    );
