unit UProviderGrafanaOnCallWebHook;
...
uses
  System.JSON,
  DataLogger, DataLogger.Provider.Grafana.OnCall.WebHook;
...
begin
  ...
  Logger.AddProvider(
    TProviderGrafanaOnCallWebHook.Create
     .URL('https://a-prod-us-central-0.grafana.net/integrations/v1/webhook/XXXXXXXXXXXX/')
    );
