...
type
  ...
  public
    function URL(const AValue: string): TProviderRESTIndy;
    ...
    function Method(const AValue: TLoggerMethod): TProviderRESTIndy;
...
function TProviderRESTIndy.Method(const AValue: TLoggerMethod): TProviderRESTIndy;
begin
  Result := Self;
  FMethod := AValue;
end;
